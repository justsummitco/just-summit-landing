...
export const metadata: Metadata = {
  title: 'Just Summit - AI-Powered Audio Learning',
  description: 'Transform podcasts and audiobooks into bite-sized AI summaries. Boost retention and learn faster with Just Summit.',
  keywords: 'AI, audio learning, podcast summaries, audiobook summaries, learning retention',
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: 'Just Summit - AI-Powered Audio Learning',
      },
    ],
    locale: 'en_US',
    type: 'website',
